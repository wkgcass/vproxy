...
version=`curl https://raw.githubusercontent.com/wkgcass/vproxy/master/base/src/main/java/vproxy/base/util/Version.java 2>/dev/null | grep '_THE_VERSION_' | awk '{print $7}' | cut -d '"' -f 2`
