...
abstract class Commands protected constructor() {
  ...
  class Res constructor(
    ...
    additionalCheck: io.vproxy.base.util.functional.ConsumerEx<Command, Exception>?,
    actions: (AddHelper<ResAct>) -> Unit,
  ) {
    val actions: MutableMap<ActType, List<ResAct>>
    val additionalCheck: io.vproxy.base.util.functional.ConsumerEx<Command, Exception>?
