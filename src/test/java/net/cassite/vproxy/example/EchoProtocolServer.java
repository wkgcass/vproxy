...
import net.cassite.vproxy.protocol.ProtocolEventLoop;
...
public class EchoProtocolServer {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        ProtocolEventLoop loop = new ProtocolEventLoop(netEventLoop, selectorEventLoop);
        ...
        loop.register(BindServer.create(new InetSocketAddress("127.0.0.1", 18080)), config, new ProtocolHandler() {
            @Override
